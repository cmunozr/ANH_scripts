...
dataReg <- read.xlsx("data/aves/I2D-BIO_2021_050_v5.xlsx", sheet = "Registros", 
                     startRow = 1, na.strings = "N/A")
dataEvent <- read.xlsx("data/aves/I2D-BIO_2021_050_v5.xlsx", sheet="Eventos", 
                       startRow = 2, na.strings = "N/A")
covs <- read.xlsx("Analisis/Covariables/BDPuntosMuestreoMag180722.xlsx", sheet=1, 
                  startRow = 1, na.strings = "N/A") %>% filter(GrupoBiolo == "Aves")
...
write.xlsx(splitReg[["T1"]], "data/aves/I2D-BIO_2021_050_v5_T1.xlsx", sheetName = "Registros")
wb <- loadWorkbook("data/aves/I2D-BIO_2021_050_v5_T1.xlsx")
addWorksheet(wb, "Eventos")
writeData(wb, "Eventos",splitEvent[["T1"]])
saveWorkbook(wb, "data/aves/I2D-BIO_2021_050_v5_T1.xlsx", overwrite = TRUE)

# constituyendo archivos de la temporada 2
write.xlsx(splitReg[["T2"]], "data/aves/I2D-BIO_2021_050_v5_T2.xlsx", sheetName = "Registros")
wb <- loadWorkbook("data/aves/I2D-BIO_2021_050_v5_T2.xlsx")
addWorksheet(wb, "Eventos")
writeData(wb, "Eventos",splitEvent[["T2"]])
saveWorkbook(wb, "data/aves/I2D-BIO_2021_050_v5_T2.xlsx", overwrite = TRUE)

# constituyendo archivo original sin tag de temporada
write.xlsx(dataReg, "data/aves/I2D-BIO_2021_050_v5_NoTag.xlsx", sheetName = "Registros")
wb <- loadWorkbook("data/aves/I2D-BIO_2021_050_v5_NoTag.xlsx")
addWorksheet(wb, "Eventos")
writeData(wb, "Eventos", dataEvent)
saveWorkbook(wb, "data/aves/I2D-BIO_2021_050_v5_NoTag.xlsx", overwrite = TRUE)
